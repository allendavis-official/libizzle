...
export default function TrackDetailPage() {
  ...
  const insights = useMemo(() => {
    ...
    const playlistAdds = parseInt(track.playlist_adds || 0);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center">
        <div className="text-white text-center">
          ...
          <p className="text-xl">Loading track data...</p>
        </div>
      </div>
    );
  }
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
            ...
            {insights && (
              <p className="text-xs text-gray-400 mt-2">
                ...
                {insights.vsArtistAvg}% vs artist avg
              </p>
            )}
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
            ...
            <p className="text-sm text-gray-300">Playlist Adds</p>
          </div>
        </div>

        {/* Track Info Card */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="md:col-span-2 bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
            ...
            <div className="space-y-3">
              ...
              {track.release_date && track.release_date !== "N/A" && (
                <div className="flex items-center justify-between py-2 border-b border-white/10">
                  ...
                  <span className="font-semibold">{track.release_date}</span>
                </div>
              )}
              ...
              {insights && (
                <div className="flex items-center justify-between py-2">
                  <span className="text-gray-400">Catalog Ranking</span>
        ...
        {/* AI Insights */}
        {insights && (
          <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 backdrop-blur-md rounded-xl p-6 border border-blue-500/30 mb-8">
            <div className="flex items-center gap-3 mb-4">
              <Target className="w-6 h-6 text-yellow-400" />
              <h2 className="text-2xl font-bold">Track Insights</h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white/10 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold">Artist Catalog Performance</h3>
                </div>
